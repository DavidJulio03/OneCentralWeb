...
const GRID_CONFIG = {
  header: {
    label: "Índice de Suministros",
    title: { main: "MÓDULOS DE", highlight: "INVENTARIO." },
...
const CategoryGrid = () => {
  const { header, categories } = GRID_CONFIG;
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-20 gap-6 md:gap-8">
          <div className="space-y-4">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-[#1e2948] tracking-tighter leading-none">
              {header.title.main} <br className="hidden xs:block" /> 
              <span className="text-[#0e7a83]">{header.title.highlight}</span>
            </h2>
          </div>
